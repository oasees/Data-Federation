import unittest
from abe_schemes.bsw07 import setup, keygen, encrypt, decrypt, encryptFile, decryptFile

class TestBSW07Methods(unittest.TestCase):
    ...
    def test_bsw07_process(self):
        setup_parameters = setup('SS512')
        msg = b'test message'
        policy = '(researcher OR doctor)'
    ...
    def test_bsw07_process_file_with_imported_parameters(self):
        setup_parameters = setup('SS512')
